...
- `build-app` and `install-app` both apply these overrides and print the resolved version before building, then print the built app's `CFBundleShortVersionString`/`CFBundleVersion`
